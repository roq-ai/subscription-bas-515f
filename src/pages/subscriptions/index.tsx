...
import { useRoqClient, useSubscriptionFindManyWithCount } from 'lib/roq';
...
export function SubscriptionListPage(props: SubscriptionListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['subscription_type.contains', 'subscription_features.contains'],
          ...params.filters,
        },
        'subscription',
      ),
  ...
  const { data, error, isLoading, mutate } = useSubscriptionFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.subscription.delete({ where: { id } });
      await mutate();
    } catch (error) {
  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.expiry_date ? format(record?.expiry_date, 'dd-MM-yyyy') : '',
    },
    { id: 'subscription_type', header: 'Subscription Type', accessorKey: 'subscription_type' },
    { id: 'subscription_duration', header: 'subscription_duration', accessorKey: 'subscription_duration' },
    { id: 'subscription_cost', header: 'Subscription Cost', accessorKey: 'subscription_cost' },
    { id: 'subscription_status', header: 'Subscription Status', accessorKey: 'subscription_status' },
    { id: 'subscription_features', header: 'Subscription Features', accessorKey: 'subscription_features' },
    !hideActions
      ? {
          id: 'actions',
          header: '',
