...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Subscription Based Tiered Messaging Service`}</title>

        <meta
          name="description"
          content="Welcome to Subscription Based Tiered Messaging Service - Your trusted partner for seamless, efficient, and secure messaging across multiple tiers. Experience the future of communication today."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1507537064587-464384459bb7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtZXNzYWdpbmclMjBzZXJ2aWNlfGVufDB8fHx8MTY5Nzg2MzE2M3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Subscription Based Tiered Messaging Service`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Subscription Based Tiered Messaging Service - Your trusted partner for seamless, efficient, and secure messaging across multiple tiers. Experience the future of communication today.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                ...
                <Card userTypeName="Subscriber" type="subscriber" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
